...
function addInventory(product, number) {
    ...
    console.log(number + " " + product.name + " added to the inventory");
    console.log("Now there are " + product.inventory + " " + product.name + " in stock.")
}
...
function processSale(product, number) {
    ...
    console.log("Total Sale: $" + (number * product.unit_price));
}
